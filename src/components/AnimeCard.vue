...
<template>
<section 
class="rounded-3xl border border-blue-700/70 bg-blue-900/60 p-5 shadow-2xl shadow-slate-950/30 backdrop-blur-sm"
>
...
<div class="flex items-center gap-3 text-cyan-300">
  ...
  <div class="grid grid-cols-3 gap-2">
    <div class="h-3 animate-pluse rounded bg-slate-700"></div>
    <div class="h-3 animate-pluse rounded bg-slate-700"></div>
    <div class="h-3 animate-pluse rounded bg-slate-700"></div>
</div>
<div class="h-72 animated-pulse rounded-2xl bg-slate-800"></div>
</div>
